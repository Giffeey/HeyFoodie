...
urlpatterns = [
    ...
    path('createcategory/', views.createCategory, name='menuupd_createCategory'),
    path('createsalesize/', views.createSalesize, name='menuupd_createSalesize'),
    path('createsalesize/', views.createSalesize, name='menuupd_createIngredient'),
    path('editmenu/create/', views.createIngredient, name='createIngredient'),
    path('editmenu/create/', views.createSalesize, name='createSalesize'),
    path('editmenu/create/', views.createCategory, name='createCategory'),
